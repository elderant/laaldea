<?php 
  ...
  $lang = $laaldea_args['lang'];

  if($lang == 'en') {
    $history_img_src = '/wp-content/uploads/aldea-history-image-en.png';
  }
  else {
    $history_img_src = '/wp-content/uploads/aldea-history-image.png';
  }
  $allies = array(
    'unicef' => array(
...
<div id="aldea">
  <section class="container-fluid">
    ...
    <div class="row awards-row mb-7">
      <div class="col-12 offset-0 px-3 col-sm-10 offset-sm-1 px-sm-0 col-lg-6 offset-lg-3 section-title pb-6">
      ...
      <ul class="col-12 offset-0 px-5 col-sm-10 offset-sm-1 px-sm-0 col-lg-6 offset-lg-3 award-texts mb-5">
        ...
        <li class="award-text mb-1">
          <?php _e('Ganadores del <span class="medium">Latino Book Awards 2020</span> con <span class="medium">La Aldea: Historias para pensar el país</span> como el mejor libro capitulado juvenil.','laaldea')?>
        </li>
        <li class="award-text mb-1">
          <?php _e('Ganadores del <span class="medium">Latino Book Awards 2020</span> con <span class="medium">La Aldea: Historias para pensar el país</span> como el mejor audiolibro.','laaldea')?>
        </li>
        <li class="award-text mb-1">
    ...
    <div class="row history-row mb-7">
      ...
      <div class="col-12 offset-0 px-3 col-md-10 offset-md-1 col-xl-8 offset-xl-2 p-md-0 section-content mb-3">
        <img src="<?php echo $history_img_src;?>" alt="<?php _e('Historia de La Aldea image', 'laaldea');?>">
      </div>
