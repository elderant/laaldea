      ...
      <div class="col-12 position-relative p-0 slider-container">
        ...
        <div class="rellax content-container text-left color-gray" data-rellax-speed="2">
          ...
          <div class="button-container text-right p d-flex">
            ...
            <a href="/historias?template=video" class="home-button text-center"><?php _e('Ver', 'laaldea');?></a>
            <a href="/historias?template=audio" class="home-button text-center"><?php _e('Escuchar', 'laaldea');?></a>
          </div>
        </div>
      </div>
    </div>
