<div id="covid">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <p class="section-intro">Esta estrategia busca acompañar a padres de familia y docentes en la explicación de la pandemia a niños y estudiantes y en la continuación de sus procesos educativos.</p>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
    ...
    <div class="row">
      <div class="col-12">
        <div class="download-button-container">
          ...
          <a href="/especial-covid" class="download-button" rel="next">Descarga los contenidos acá</a>
        </div>
      </div>
    </div>
    <div class="row">
