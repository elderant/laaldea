    ...
    <div class="row button-container">
      <div class="col-12">
        <div class="text-container d-flex justify-content-center align-items-center">
          <img src="/wp-content/uploads/click-design-triangle-original.png" alt="design triangle">
          <a href="https://clickarte.co/" target="_blank" rel="external noopener noreferrer">www.clickarte.co</a>
        </div>
      </div>
    </div>
  </div>
