    ...
    <div class="row">
      ...
      <div class="col-12 position-relative p-0 slider-container d-flex flex-row justify-content-start">
        <div class="background-container position-absolute">
          ...
          <img class="rellax background-part background-character-3" src="/wp-content/uploads/news-char-1.png" alt="<?php _e('Lucy image in news section', 'laaldea');?>" data-rellax-speed="-4">
          ...
          <img class="rellax background-part background-character" src="/wp-content/uploads/news-char-3.png" alt="<?php _e('A Moorhen image in news section', 'laaldea');?>" data-rellax-speed="-4">
          ...
          <img class="rellax background-part background-character-4" src="/wp-content/uploads/news-char-4.png" alt="<?php _e('A Moorhen image in news section', 'laaldea');?>" data-rellax-speed="-4">
        </div>
        <?php if( $recent_post -> have_posts() ) : ?>
          ...
          <?php while ($recent_post -> have_posts()) : ?>
            <?php 
              ...
              $post_id = get_the_ID();
              laaldea_get_aldea_post_html($post_id, $position);
              $position = $position + 1;
            ?>
          <?php endwhile; ?>
