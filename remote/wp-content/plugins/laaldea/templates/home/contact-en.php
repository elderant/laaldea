  ...
  <div class="container-fluid">
    ...
    <div class="row subtitle-row">
      <div class="col-8 offset-2">
        <h4><?php _e('¿Quieres saber más de nosotros?', 'laaldea');?></h4>
        <h4><?php _e('¿Quieres llevar La Aldea a tu comunidad?', 'laaldea');?></h4>
      </div>
    </div>
    <div class="row aldea-form-row">
      <div class="col-6 offset-3 text-container">
        <?php echo do_shortcode('[contact-form-7 id="244" title="home contact form_copy"]'); ?>
      </div>
    </div>
