<?php
  $user_avatars = array(
    'arnulfo' => array (
      ...
      'label-alt' => __('Avatar Arnulfo','user-flow'),
    ),
    'lucy' => array (
      ...
      'label-alt' => __('Avatar Lorena','user-flow'),
    ),
    'enrique' => array (
      ...
      'label-alt' => __('Avatar Enrique','user-flow'),
    ),
    'efren' => array (
      ...
      'label-alt' => __('Avatar Efrén','user-flow'),
    ),
    'macaw' => array (
      ...
      'label-alt' => __('Avatar guacamaya','user-flow'),
    ),
    'carmen' => array (
      ...
      'label-alt' => __('Avatar Carmen','user-flow'),
    ),
    'paco' => array (
      ...
      'label-alt' => __('Avatar Paco','user-flow'),
    ),
    'ant' => array (
      ...
      'label-alt' => __('Avatar hormiga','user-flow'),
    ),
    'bee' => array (
      ...
      'label-alt' => __('Avatar Abeja','user-flow'),
    ),
    'gallineta' => array (
      ...
      'label-alt' => __('Avatar gallineta','user-flow'),
    ),
    'owl' => array (
      ...
      'label-alt' => __('Avatar búho','user-flow'),
    ),
  );
